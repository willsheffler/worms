...
# from worms.viz.plot import plot3d, scatter
...
def check_geometry(ssdag, crit, rslt, max_porosity, max_com_redundancy, **kw):
   ...
   symframes = dict(T=sym.tetrahedral_frames, O=sym.octahedral_frames, I=sym.icosahedral_frames)
