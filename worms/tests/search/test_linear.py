...
def test_linear_search_two(bbdb_fullsize_prots):
    ...
    v = Vertex(bbs, 'N_')
    verts = (u, v)
    edges = (Edge(u, bbs, v, bbs, splice_max_rms=1.1, splice_rms_range=9), )
...
def test_linear_search_three(bbdb_fullsize_prots):
    ...
    w = Vertex(bbs, 'N_')
    verts = (u, v, w)
    e = Edge(u, bbs, v, bbs, splice_max_rms=1.1, splice_rms_range=9)
    f = Edge(v, bbs, w, bbs, splice_max_rms=1.1, splice_rms_range=9)
    edges = (e, f)
